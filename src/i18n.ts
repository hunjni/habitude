...
const en: Dict = {
	...
	'type.good': 'Good habit',
	'type.bad': 'Bad habit',
	'checklist.changeType': 'Change type → {{target}}',
	'checklist.changeTypeNotice': '"{{title}}" type changed. Past checkmarks are now interpreted under the new semantics.',
	'planNote.suffix': ' Plan',
	'planNote.meta': 'Execution plan generated {{date}}. Edit or regenerate it from the habit details.',
	'planNote.fieldsSection': 'Core recipe',
	'planNote.phasesSection': 'Phase timeline',
	'detail.planOpenNote': '📄 Open plan note',
	'detail.planNoteMissing': 'Plan note not found — save or regenerate the plan first.',
	...
	'checklist.deleteHabit': 'Delete habit',
	'checklist.deleteHabitConfirm':
		'Delete "{title}" permanently? Its check history and plan data are removed. Generated knowledge/plan notes stay in the vault and can be deleted separately.',
	'checklist.deleteHabitOk': 'Delete',
	'checklist.habitDeleted': 'Habit deleted: {title}',
...
const ko: Dict = {
	...
	'type.good': '좋은 습관',
	'type.bad': '나쁜 습관',
	'checklist.changeType': '유형 변경 → {{target}}',
	'checklist.changeTypeNotice': '"{{title}}" 유형이 변경되었습니다. 기존 체크 기록은 새 의미로 해석됩니다.',
	'planNote.suffix': ' 실행 계획',
	'planNote.meta': '{{date}}에 생성된 실행 계획입니다. 습관 상세에서 편집하거나 다시 생성하세요.',
	'planNote.fieldsSection': '핵심 실행 방법',
	'planNote.phasesSection': '단계 타임라인',
	'detail.planOpenNote': '📄 실행 계획 노트 열기',
	'detail.planNoteMissing': '실행 계획 노트를 찾을 수 없습니다 — 먼저 계획을 저장하거나 다시 생성하세요.',
	...
	'checklist.deleteHabit': '습관 삭제',
	'checklist.deleteHabitConfirm':
		'"{title}"을(를) 완전히 삭제할까요? 체크 기록과 계획 데이터가 함께 제거됩니다. 생성된 지식/실행 계획 노트는 볼트에 남으며 별도로 삭제할 수 있습니다.',
	'checklist.deleteHabitOk': '삭제',
	'checklist.habitDeleted': '습관 삭제됨: {title}',
...
const zh: Dict = {
	...
	'type.good': '好习惯',
	'type.bad': '坏习惯',
	'checklist.changeType': '更改类型 → {{target}}',
	'checklist.changeTypeNotice': '「{{title}}」类型已更改。过去的打卡记录将按新类型的语义解读。',
	'planNote.suffix': '执行方案',
	'planNote.meta': '执行方案生成于 {{date}}，可在习惯详情中编辑或重新生成。',
	'planNote.fieldsSection': '核心做法',
	'planNote.phasesSection': '阶段安排',
	'detail.planOpenNote': '📄 打开执行方案笔记',
	'detail.planNoteMissing': '未找到方案笔记——请先在习惯详情中保存或重新生成方案。',
	...
	'checklist.deleteHabit': '删除习惯',
	'checklist.deleteHabitConfirm':
		'确定永久删除「{title}」吗？它的打卡历史和方案数据会一并移除。已生成的知识卡与执行方案笔记会保留在库中，可之后手动删除。',
	'checklist.deleteHabitOk': '删除',
	'checklist.habitDeleted': '习惯已删除：{title}',
