...
const en: Dict = {
	...
	'settings.llmModel.desc': 'Model used by the AI coach. Pick from the built-in presets — no URL or id typing needed.',
...
const ko: Dict = {
	...
	'settings.llmModel.desc': 'AI 코치가 사용하는 모델. 내장 프리셋에서 선택하세요 — URL이나 ID 입력이 필요 없습니다.',
	'settings.baseUrl.name': 'API Base URL',
...
const zh: Dict = {
	...
	'settings.llmModel.desc': 'AI 教练使用的模型。从内置预置中选择即可——无需手填网址或模型 ID。',
	'settings.baseUrl.name': 'API Base URL',
